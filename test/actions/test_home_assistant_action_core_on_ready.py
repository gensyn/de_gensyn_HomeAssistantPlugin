...
from test.stream_controller_mock.src.backend.PluginManager.ActionCore import ActionCore
...
class TestHomeAssistantActionCoreOnReady(unittest.TestCase):
    ...
    @patch.object(HomeAssistantActionCore, "_load_domains")
    @patch.object(HomeAssistantActionCore, "_load_entities")
