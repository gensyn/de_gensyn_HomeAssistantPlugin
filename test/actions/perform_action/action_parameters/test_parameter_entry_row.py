...
from de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row import ParameterEntryRow


class TestParameterEntryRow(unittest.TestCase):

    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.EntryRow.__init__')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.ParameterRow.__init__')
    ...
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.EntryRow.get_text')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.EntryRow.__init__')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.ParameterRow.__init__')
    ...
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.EntryRow.set_value')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.EntryRow.__init__')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.ParameterRow.__init__')
    ...
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.EntryRow._value_changed')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.EntryRow.__init__')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.ParameterRow._on_change')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row.ParameterRow.__init__')
