...
class TestParameterSwitchRow(unittest.TestCase):
    ...
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.SwitchRow.__init__')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.ParameterRow.__init__')
    ...
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.SwitchRow.get_active')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.SwitchRow.__init__')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.ParameterRow.__init__')
    ...
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.SwitchRow.set_value')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.SwitchRow.__init__')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.ParameterRow.__init__')
    ...
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.SwitchRow._value_changed')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.SwitchRow.__init__')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.ParameterRow._on_change')
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_switch_row.ParameterRow.__init__')
