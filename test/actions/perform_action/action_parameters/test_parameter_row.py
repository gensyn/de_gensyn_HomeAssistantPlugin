...
from de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_entry_row import ParameterRow
...
class TestParameterEntryRow(unittest.TestCase):
    ...
    @patch(
        'de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_row.ParameterRow.get_parameter_value')
...
def create_instance(required: bool, parameters: Dict={}, field_name: str="test_field") -> ParameterRow:
    ...
    with patch('de_gensyn_HomeAssistantPlugin.actions.perform_action.action_parameters.parameter_row.CheckButton') as check_button_mock:
